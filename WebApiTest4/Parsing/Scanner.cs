...
namespace WebApiTest4.Parsing
{
    public class Scanner
    {
        ...
        public async void  addNewTasks(EgeDbContext egeDbContext)
        {
            ...
            foreach (var cell in cells)
            {
                ...
                if (egeDbContext.TaskTopics.Where(x => x.Number == newTopic.Number).Count() == 0)
                {
                ...
                if (egeDbContext.Tasks.Where(x => x.Number == newTask.Number).Count() == 0)
                {
